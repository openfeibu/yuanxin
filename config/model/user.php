...
return [
    ...
    'user'     => [
        'model' => [
            ...
            'appends'       => [],
            'fillable'      => [ 'name','email','nickname','open_id','session_key','phone','avatar_url','city','gender','password','remember_token','client_id','verified','verification_token','created_at','updated_at'],
            'translate'     => [],
