                ...
                <form class="layui-form" action="{{guard_url('page/about/'.$page->id)}}" method="post" lay-filter="fb-form">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="title" autocomplete="off" placeholder="请输入{{ trans('page.label.title') }}" class="layui-input" value="{{$page->title}}">
                        </div>
                    </div>
                    <div class="layui-form-item">
                        <label class="layui-form-label">{{ trans('page.label.image') }}<br>(756 * 334)</label>
                        {!! $page->files('image')
