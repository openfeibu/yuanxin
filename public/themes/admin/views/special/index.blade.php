        ...
        <div class="layui-col-md12">
            ...
            <div class="tabel-message">
                <div class="layui-inline tabel-btn">
                    <button class="layui-btn layui-btn-warm "><a href="{{guard_url('page/special/create')}}">{{ trans('app.add') }}</a></button>
...
<script>
    var main_url = "{{guard_url('page/special')}}";
    var delete_all_url = "{{guard_url('page/special/destroyAll')}}";
    layui.use(['jquery','element','table'], function(){
        ...
        table.render({
            ...
            ,cols: [[
                ...
                ,{field:'link',title:'{{ trans('page.label.link') }}',edit:'text' ,width:150}
