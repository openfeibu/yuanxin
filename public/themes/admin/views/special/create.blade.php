    ...
    <div class="main_full">
        ...
        <div class="layui-col-md12">
            <div class="fb-main-table">
                <form class="layui-form" action="{{guard_url('page/special')}}" method="post" lay-filter="fb-form">
                    ...
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <input type="text" name="link"  autocomplete="off" placeholder="请输入{{ trans('page.label.link') }}" class="layui-input" >
                        </div>
