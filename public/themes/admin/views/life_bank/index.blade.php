        ...
        <div class="layui-col-md12">
            ...
            <div class="tabel-message">
                <div class="layui-inline tabel-btn">
                    <button class="layui-btn layui-btn-warm "><a href="{{guard_url('page/life_bank/create')}}">{{ trans('app.add') }}</a></button>
...
<script>
    var main_url = "{{guard_url('page/life_bank')}}";
    var delete_all_url = "{{guard_url('page/life_bank/destroyAll')}}";
